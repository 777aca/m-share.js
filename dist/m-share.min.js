(function (global, factory) {
  ...
  var qzoneShare = function (info) {
    ...
    var query =
      ...
      "&desc=" +
      encodeURIComponent(info.desc) +
      "&summary=" +
      encodeURIComponent(info.desc) +
      "&site=" +
      encodeURIComponent(info.link);
    location.href =
      "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?" + query;
  };
  var weiboShare = function (info) {
    ...
    var query =
      ...
      encodeURIComponent(info.desc) +
      "&pic=" +
      encodeURIComponent(info.imgUrl);
  ...
  var typesMap = ["wx", "wxline", "qq", "qzone", "weibo"];
  ...
  var index = {
      ...
      var getTmpl = function getTmpl(type) {
        if (typesMap.indexOf(type) >= 0) {
          return (
            '<i class="m-share-' +
            type +
            " m-share-iconfont m-share-iconfont-" +
            type +
            '"></i>'
          );
        }
    ...
    popup: function popup(config) {
      ...
      var getTmpl = function getTmpl(type) {
        if (typesMap.indexOf(type) >= 0) {
          return (
            '<div class="m-share-cell"><i class="m-share-' +
            type +
            " m-share-iconfont m-share-iconfont-" +
            type +
            '"></i><div class="m-share-sheet-title">' +
            textMap[type] +
            "</div></div>"
          );
        }
